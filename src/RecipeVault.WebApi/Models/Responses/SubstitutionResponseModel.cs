...
namespace RecipeVault.WebApi.Models.Responses {
    /// <summary>
    /// Response model containing substitution suggestions
    /// </summary>
    public class SubstitutionResponseModel {
        /// <summary>
    ...
    public class IngredientSubstitutionModel {
        ...
        /// </summary>
        public List<SubstitutionOptionModel> Options { get; set; } = new();
    }

    /// <summary>
    /// A single substitution option
    /// </summary>
    public class SubstitutionOptionModel {
        /// <summary>
        ...
        /// </summary>
        public List<SubstitutionIngredientModel> Ingredients { get; set; } = new();
    ...
    /// </summary>
    public class SubstitutionIngredientModel {
        /// <summary>
        /// Quantity as decimal
        /// </summary>
