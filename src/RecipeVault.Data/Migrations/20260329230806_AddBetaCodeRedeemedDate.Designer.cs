...
namespace RecipeVault.Data.Migrations
{
    ...
    [Migration("20260329230806_AddBetaCodeRedeemedDate")]
    partial class AddBetaCodeRedeemedDate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RecipeVault.Domain.Entities.ApiToken", b =>
                {
                    b.Property<int>("ApiTokenId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("ApiTokenId"));

                    b.Property<Guid>("ApiTokenResourceId")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("ApiToken", "public", t =>
                        {
                            t.HasTrigger("trApiToken");
                        });
                });
            ...
            modelBuilder.Entity("RecipeVault.Domain.Entities.BetaInviteCode", b =>
                {
                    b.Property<int>("BetaInviteCodeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("BetaInviteCodeId"));

                    b.Property<Guid>("BetaInviteCodeResourceId")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("BetaInviteCodeId");

                    b.HasIndex("BetaInviteCodeResourceId")
                        .IsUnique();
                    ...
                    b.ToTable("BetaInviteCode", "public", t =>
                        {
                            t.HasTrigger("trBetaInviteCode");
                        });
                });

            modelBuilder.Entity("RecipeVault.Domain.Entities.BetaInviteCodeRedemption", b =>
                {
                    b.Property<int>("BetaInviteCodeRedemptionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("BetaInviteCodeRedemptionId"));
                    ...
                    b.HasKey("BetaInviteCodeRedemptionId");

                    b.HasIndex("BetaInviteCodeId");

                    b.HasIndex("SubjectId");

                    b.ToTable("BetaInviteCodeRedemption", "public", t =>
                        {
                            t.HasTrigger("trBetaInviteCodeRedemption");
                        });
                });
            ...
            modelBuilder.Entity("RecipeVault.Domain.Entities.IngredientSynonym", b =>
                {
                    b.Property<int>("IngredientSynonymId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("IngredientSynonymId"));
                    ...
                    b.ToTable("IngredientSynonym", "public", t =>
                        {
                            t.HasTrigger("trIngredientSynonym");
                        });
                });
            ...
            modelBuilder.Entity("RecipeVault.Domain.Entities.PremiumWaitlist", b =>
                {
                    b.Property<int>("PremiumWaitlistId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("PremiumWaitlistId"));
                    ...
                    b.Property<Guid>("PremiumWaitlistResourceId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("PremiumWaitlistResourceId")
                        .IsUnique();

                    b.ToTable("PremiumWaitlist", "public", t =>
                        {
                            t.HasTrigger("trPremiumWaitlist");
                        });
                });
            ...
            modelBuilder.Entity("RecipeVault.Domain.Entities.Recipe", b =>
                {
                    ...
                    b.Property<bool>("IsSampleRecipe")
                        .HasColumnType("boolean");
                    ...
                    b.Property<string>("ShowcaseFeature")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");
            ...
            modelBuilder.Entity("RecipeVault.Domain.Entities.RecipeTag", b =>
                {
                    ...
                    b.Property<string>("NormalizedEntityType")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");
            ...
            modelBuilder.Entity("RecipeVault.Domain.Entities.UserAccount", b =>
                {
                    ...
                    b.Property<string>("OnboardingProgressJson")
                        .HasColumnType("text");

                    b.Property<Guid>("SubjectId")
                        .HasColumnType("uuid");

                    b.Property<DateTime?>("TierChangedDate")
                        .HasColumnType("timestamp with time zone");

                    b.Property<Guid>("UserAccountResourceId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("UserAccountResourceId")
                        .IsUnique();

                    b.ToTable("UserAccount", "public", t =>
                        {
                            t.HasTrigger("trUserAccount");
                        });
                });
            ...
            modelBuilder.Entity("RecipeVault.Domain.Entities.UserPantryItem", b =>
                {
                    b.Property<int>("UserPantryItemId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("UserPantryItemId"));
                    ...
                    b.HasIndex("SubjectId", "IngredientName")
                        .IsUnique();

                    b.HasIndex("SubjectId", "IsStaple");

                    b.ToTable("UserPantryItem", "public", t =>
                        {
                            t.HasTrigger("trUserPantryItem");
                        });
                });
            ...
            modelBuilder.Entity("RecipeVault.Domain.Entities.BetaInviteCodeRedemption", b =>
                {
                    b.HasOne("RecipeVault.Domain.Entities.BetaInviteCode", "BetaInviteCode")
                        .WithMany("Redemptions")
                        .HasForeignKey("BetaInviteCodeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("BetaInviteCode");
                });
